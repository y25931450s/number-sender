...
import com.xiaoying.base.numbersender.exception.CheckLastTimeException;
 ...
 * @created:2019/3/12
 * @function: 保持snowflake zookeeper相关信息,主要是通过zk保存时间和生成workerId，防止重复
 */
public class SnowflakeZookeeperHolder implements InitializingBean {
    ...
    private static  final String NUMBER_SENDER_PATH = "number_sender";
    private int workerID;
    private static final String PREFIX_ZK_PATH = "/snowflake/" + NUMBER_SENDER_PATH;
    ...
    private boolean init() {
        try {
            ...
            throw new RuntimeException("Start node ERROR");
        }
        return true;
    }
